(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash.deburr'), require('rxjs/internal/Subject'), require('rxjs'), require('@angular/forms'), require('@angular/core'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ngx-extended-pdf-viewer', ['exports', 'lodash.deburr', 'rxjs/internal/Subject', 'rxjs', '@angular/forms', '@angular/core', '@angular/common'], factory) :
    (factory((global['ngx-extended-pdf-viewer'] = {}),global.deburr,global.rxjs['internal/Subject'],global.rxjs,global.ng.forms,global.ng.core,global.ng.common));
}(this, (function (exports,deburr,Subject,rxjs,forms,i0,common) { 'use strict';
    ...
    var PDFNotificationService = /** @class */ (function () {
        function PDFNotificationService() {
            ...
            this.onPDFJSInit = new Subject.Subject();
        }
    ...
    var NgxExtendedPdfViewerComponent = /** @class */ (function () {
        function NgxExtendedPdfViewerComponent(ngZone, platformId, notificationService) {
            this.ngZone = ngZone;
